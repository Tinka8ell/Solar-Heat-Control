...
Created to allow the controller to use multiple backing stores.
The idea was to use Google sheets, UPIDots and file system
until final repository was defined.
