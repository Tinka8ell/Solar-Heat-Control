...
"""
Google version of the backing store.
Uses Google Drive API to access Google Sheets as a repository.
This was the original design, before the UBIDots implementation.
"""
    ...
    def getSpreadsheet(self, fileName, keys):
        ...
        if not spreadsheetId:
            ...
            result = service.spreadsheets().values().update(spreadsheetId=spreadsheetId,
                                                            ...
                                                            body=body).execute()
            print("Started new spreadsheet called", fileName,
                  "and can be found at", spreadsheetId)
