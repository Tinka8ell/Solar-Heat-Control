...
#from Solar.GoogleBackingStore import BackingStore
...
#      global clock
   ...
   def getPeriod(self):
      period = int(self.properties.get('Period', 5)) # give a minimum of 5 secs
      if period < 5:
         period = 5
...
if __name__ == "__main__":
   ...
   print("Called Monitor.py with __name__ ==", __name__, "and args:", sys.argv)
